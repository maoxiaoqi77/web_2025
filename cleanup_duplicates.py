...
for page in pages:
    ...
    try:
        ...
        # 修复768px media query中的重复margin声明
        content = re.sub(
            r'(\.project-content \{[^\}]*?)margin: calc\(100vh \+ 20px\) 20px 40px;\s*padding: 0;\s*margin: calc\(100vh \+ 20px\) 20px 40px;',
